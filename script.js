...
async function newQuizQuestion(){
  const categoryId = el('quizCategory').value; // get selected category
...
async function loadCommunityIdeas() {
  try {
    const res = await fetch('/ideas');  // Make sure your server serves /ideas JSON
...
// Auto-load activity + meme
fetchRandomActivity(); fetchMeme();
loadCommunityIdeas();
